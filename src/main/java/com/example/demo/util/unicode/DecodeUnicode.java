...
public class DecodeUnicode {
    ...
    public static void main(String[] args){
        ...
        try {
        	String url="http://image.yyfq.com/econtract/20181121/contract/23403075/dist/纸质退回来_ZX2018112119325312998803043000.pdf";
            if(StringUtils.isNotEmpty(url) && url.contains(".pdf")){
                String[] arr = url.split("/");
                String name=arr[arr.length-1];
                String[] names = name.split("_");
                String urlString = URLEncoder.encode(names[0], "GBK");
