package com.example.demo.util.thirdParty.zooKeeper;
...
public class ZooKeeperClient {
    ...
    public static void main(String[] args) throws Exception{
        ...
        zooKeeper.create("/RootNode", "RootNodeData".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);//创建一个节点名为“/RootNode”的目录节点
        ...
        zooKeeper.create("/RootNode/ChildNode1", "ChildNode1Data".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT);//在“RootNode”节点下创建一个名为“ChildNode1”的子目录节点
        zooKeeper.create("/RootNode/ChildNode2", "ChildNode2Data".getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE,CreateMode.PERSISTENT);//在“RootNode”节点下创建一个和“ChildNode1”同级的名为“ChildNode2”的子目录节点
