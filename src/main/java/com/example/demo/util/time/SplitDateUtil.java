...
public class SplitDateUtil {
    ...
    public static void main(String[] args) {
        List<KeyValueForDate> list = SplitDateUtil.getMonthStartAndEndTimeForDate("2015-08-23","2016-06-10");
    ...
    public static List<KeyValueForDate> getMonthStartAndEndTimeForDate(String startDate,String endDate) {
