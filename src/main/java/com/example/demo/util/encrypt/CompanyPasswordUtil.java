 ...
 */
public class CompanyPasswordUtil {
    private static Logger LOG = LoggerFactory.getLogger(CompanyPasswordUtil.class);
    ...
    public static void main(String[] args) {
        String pwd = CompanyPasswordUtil.encrypt("youjie.com");
