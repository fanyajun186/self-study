...
public class JavaUtil {
     ...
     * @throws Exception 
     */
    /*public static String getStrBase64(String appCode, String imgUrl) throws Exception {
        try {
            return FileCommonUtil.getStrBase64(imgUrl);
        } catch (Exception e) {
            throw new Exception("本地JavaUtil类根据url加密获取base64数据失败");
        }
    }*/
     ...
     * @throws Exception 
     */
    public static <T> T instanceClass(String fillName,String initMethod, Object ... params) throws Exception{
        try {
     ...
     * @throws Exception 
     */
    public static <T> T instanceClass(String fillName,String initMethod,String[] fieldNames,Object ... fieldValues) throws Exception{
        try {
            Class tClass = Class.forName(fillName);
            if(Objects.isNull(tClass)){
                return null;
